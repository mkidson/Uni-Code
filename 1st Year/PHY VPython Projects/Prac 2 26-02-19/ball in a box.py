...
# objects
ball = sphere(pos=vector(0,0,0), radius=0.5, velocity=vector(0,0,0), color=color.cyan)

# creates a box with side length 20 and with a centre at the origin.
...
# initial values
#ball.velocity = vector(5,10,15)

ball.velocity = vector(20,5,2)   # assigns the ball a velocity of (0,0,0)
#ball.velocity.x = eval(input("What is the ball's velocity in the x direction: ")) # asks for a velocity in the x direction
#ball.velocity.y = eval(input("What is the ball's velocity in the y direction: ")) # asks for a velocity in the y direction
#ball.velocity.z = eval(input("What is the ball's velocity in the z direction: ")) # asks for a velocity in the z direction

deltat = 0.005          
t = 0                   
vscale = 0.1            # scales the velocity vector arrow
scene.autoscale = 0
...
while t < 3:
    ...
    #ball.velocity.y += gravity.y*deltat

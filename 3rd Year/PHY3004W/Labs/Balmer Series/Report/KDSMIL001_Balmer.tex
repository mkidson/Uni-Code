...
\usepackage{listings,xcolor,caption,import,wrapfig,subcaption}
\usepackage[version=4]{mhchem}
\captionsetup[subfloat]{labelformat=empty}
\graphicspath{{Plots/Calibration}}
...
\begin{figure}[H]%
    \subfloat[\centering Increment: 0.2A, Dwell Time: 200ms, Slit Width: 5$\mu$m, Range: 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_0.2A_200ms_05um_6300to6400.csv.pgf}}}
    \,
    \subfloat[\centering 0.2 A, 200 ms, 10 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_0.2A_200ms_10um_6300to6400.csv.pgf}}}
\end{figure}
\begin{figure}[H]%
    \subfloat[\centering 0.2 A, 200 ms, 15 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_0.2A_200ms_15um_6300to6400.csv.pgf}}}
    \,
    \subfloat[\centering 0.5 A, 200 ms, 5 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_0.5A_200ms_05um_6300to6400.csv.pgf}}}
\end{figure}
\begin{figure}[H]%
    \subfloat[\centering 0.5 A, 200 ms, 10 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_0.5A_200ms_10um_6300to6400.csv.pgf}}}
    \,
    \subfloat[\centering 0.5 A, 200 ms, 15 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_0.5A_200ms_15um_6300to6400.csv.pgf}}}
\end{figure}
\begin{figure}[H]%
    \subfloat[\centering 0.8 A, 200 ms, 5 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_0.8A_200ms_05um_6300to6400.csv.pgf}}}
    \,
    \subfloat[\centering 0.8 A, 200 ms, 10 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_0.8A_200ms_10um_6300to6400.csv.pgf}}}
\end{figure}
\begin{figure}[H]%
    \subfloat[\centering 0.8 A, 200 ms, 15 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_0.8A_200ms_15um_6300to6400.csv.pgf}}}
    \,
    \subfloat[\centering 1.0 A, 200 ms, 5 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_1.0A_200ms_05um_6300to6400.csv.pgf}}}
\end{figure}
\begin{figure}[H]%
    \subfloat[\centering 1.0 A, 200 ms, 10 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_1.0A_200ms_10um_6300to6400.csv.pgf}}}
    \,
    \subfloat[\centering 1.0 A, 200 ms, 15 $\mu$m, 6300-6400 A]{\scalebox{0.5}{\subimport{Plots/calibration}{HeNe_1.0A_200ms_15um_6300to6400.csv.pgf}}}
\end{figure}

\subsection{Spectral Line Data}\label{sec:Spectral Line Data}
\begin{figure}[H]%
    \subfloat[\centering Line: H-$\alpha$, Increment: 0.2 A, Dwell Time: 300 ms, Slit Width: 100 $\mu$m, Range: 6562-6600 A]{\scalebox{0.5}{\subimport{Plots/Spectral}{H3-210808-1304-100um-300ms-6562-6600A-0.2A-lightsOff.csv.pgf}}}
    \,
    \subfloat[\centering H-$\alpha$, 0.2 A, 300 ms, 50 $\mu$m, 6561-6600 A]{\scalebox{0.5}{\subimport{Plots/Spectral}{H3-210808-1308-050um-300ms-6561-6600A-0.2A-lightsOff.csv.pgf}}}
\end{figure}
\begin{figure}[H]%
    \subfloat[\centering H-$\alpha$, 0.2 A, 300 ms, 20 $\mu$m, 6557-6600 A]{\scalebox{0.5}{\subimport{Plots/Spectral}{H3-210808-1311-020um-300ms-6557-6600A-0.2A-lightsOff.csv.pgf}}}
    \,
    \subfloat[\centering H-$\beta$, 0.2 A, 300 ms, 20 $\mu$m, 4861-4900 A]{\scalebox{0.5}{\subimport{Plots/Spectral}{H4-210808-1300-020um-300ms-4861-4900A-0.2A-lightsOff.csv.pgf}}}
\end{figure}
\begin{figure}[H]%
    \subfloat[\centering H-$\gamma$, 0.2 A, 300 ms, 100 $\mu$m, 4338-4380 A]{\scalebox{0.5}{\subimport{Plots/Spectral}{H5-210808-1239-100um-300ms-4338-4380A-0.2A-lightsOff.csv.pgf}}}
    \,
    \subfloat[\centering H-$\gamma$, 0.2 A, 300 ms, 50 $\mu$m, 4332-4380 A]{\scalebox{0.5}{\subimport{Plots/Spectral}{H5-210808-1244-050um-300ms-4332-4380A-0.2A-lightsOff.csv.pgf}}}
\end{figure}
\begin{figure}[H]%
    \subfloat[\centering H-$\gamma$, 0.2 A, 300 ms, 20 $\mu$m, 4340-4380 A]{\scalebox{0.5}{\subimport{Plots/Spectral}{H5-210808-1247-020um-300ms-4340-4380A-0.2A-lightsOff.csv.pgf}}}
    \,
    \subfloat[\centering H-$\delta$, 0.2 A, 300 ms, 100 $\mu$m, 4099-4150 A]{\scalebox{0.5}{\subimport{Plots/Spectral}{H6-210808-1201-100um-300ms-4099-4150A-0.2A-lightsOff.csv.pgf}}}
\end{figure}
\begin{figure}[H]%
    \subfloat[\centering H-$\delta$, 0.2 A, 300 ms, 50 $\mu$m, 4099-4150 A]{\scalebox{0.5}{\subimport{Plots/Spectral}{H6-210808-1210-050um-300ms-4099-4150A-0.2A-lightsOff.csv.pgf}}}
    \,
    \subfloat[\centering H-$\delta$, 0.2 A, 300 ms, 20 $\mu$m, 4102-4150 A]{\scalebox{0.5}{\subimport{Plots/Spectral}{H6-210808-1218-020um-300ms-4102-4150A-0.2A-lightsOff.csv.pgf}}}
\end{figure}

...
plt.legend()
plt.annotate(r'$\mu=$'+str(round(dataMu, 6))+'$; \sigma=$'+str(round(dataSigma, 6)), (dataMu, gaussianMax), textcoords='offset points', xytext=(10, 10), bbox=dict(facecolor='orange', edgecolor='black', boxstyle='round'))
plt.savefig('ApproxPi2.pgf')
# plt.show()
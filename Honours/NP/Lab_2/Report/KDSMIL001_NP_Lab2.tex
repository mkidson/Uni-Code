...
In each case, the expected energies of the most prominent photopeaks were determined, either by looking them up on NuDat~\cite{nudat} or by determining the theoretical energy by means of a binding energy calculation. These were then compared to the observed photopeaks. In the case of \ce{^{152}Eu}, the energy calibration was found to likely have a slightly incorrect value for the slope of the function. The AmBe calibration appeared to be reasonable and met expectations but a peak was found in the spectrum at $\sim\SI{2560}{\kilo\electronvolt}$ that was not explained by experimental or theoretical expectation. 

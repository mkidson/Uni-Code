...
for n in range(1,181):
    ...
    # region Ingest data
    file = open(f'3rd Year\PHY3004W\Labs\Half-life\Report\Task 3\Faaris Analysis\Data\Aluminum stuff_{n}.tsv', 'r')
...
for p in range(1):
    try:
        ...
        approxCentroid=(data[0][520]+data[0][585])/2
...
plt.show()
# plt.savefig(r'3rd Year\PHY3004W\Labs\Half-life\Report\Task 3\28AlSpectrum.pgf')

...
\begin{document}
    ...
    \begin{itemize}
        ...
        a value of $\pi = 3.141615 \pm 0.000052$. %pi =  3.141615408  +/-  5.162349049951582e-05
        
        \begin{figure}[H]
            \begin{center}
               \scalebox{.7}{\input{ApproxPi3.pgf}}
        ...
        a more accurate approximation. %pi =  3.141590832  +/-  5.4235216213824e-05

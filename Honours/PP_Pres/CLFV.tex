    ...
    \begin{columns}[c]
        \begin{column}{0.6\textwidth}
            \begin{itemize}
                ...
                \item the SINDRUM experiment puts a rate limit of $10^{-12}$ with future experiments aiming for $10^{-16}$\footnote[frame]{Ardu, M., \& Pezzullo, G. (2022). Introduction to Charged Lepton Flavour Violation}
            \end{itemize}
        \end{column}

...
\begin{enumerate}
    \item \begin{enumerate}
        ...
        \item Performing the integral $I$ in \cref{eqn:Q1Integral} in Mathematica, we find the exact result to be $\frac{41}{4}=10.25$. We see that Gauss-Laguerre worked very well, producing the result to an accuracy that could likely be waved away with computer precision. We also see that the Monte Carlo method result agrees with the exact and Gauss-Laguerre results.

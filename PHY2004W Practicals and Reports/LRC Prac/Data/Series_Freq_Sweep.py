...
file = open('PHY2004W Practicals and Reports\LRC Prac\Data\Series_Freq_Sweep.txt', 'r')
...
resonantIndex=find_peaks(data[1])[0][0]
resFreq=data[0][resonantIndex]
resFreqVoltage=data[1][resonantIndex]
# Returns an array of indices for which the value of the function is greater than max/sqrt(2)
...
Q=resFreq/deltaF2
print('Resistance is 200 Hz')
print('The Resonant Frequency is',resFreq,'Hz')
print('The Quality Factor is',Q)

# Plotting the data
plt.figure()
plt.plot(data[0],data[1],color='b',linewidth=0.7,label='Series Sweep Data for 200 Hz')

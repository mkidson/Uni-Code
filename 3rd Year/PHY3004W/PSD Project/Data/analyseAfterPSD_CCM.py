...
#     FoM = (photonsPopt[0]-neutronsPopt[0])/(2.35*photonsPopt[1]+2.35*neutronsPopt[1])
#     FoMErr = FoM*sqrt((sqrt(photonsPcov[0,0]**2+neutronsPcov[0,0]**2)/(photonsPopt[0]-neutronsPopt[0]))**2 + (sqrt((2.35*photonsPcov[1,1])**2 + (2.35*neutronsPcov[1,1])**2)/(2.35*photonsPopt[1]+2.35*neutronsPopt[1])))
#     print(FoM, FoMErr)

# plt.show()
plt.savefig('Plots/CCM_STNG_hist2d.png')
...
\title[ITS \& MFT Analysis]{A preliminary analysis of data from ALICE's new ITS and MFT detectors} % The short title in the optional parameter appears at the bottom of every slide, the full title in the main parameter is only on the title page
